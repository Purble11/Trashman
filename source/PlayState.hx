...
class PlayState extends MusicBeatState
{
				...
				case 'trashman' | 'rotten' | 'mutant':
					{
						defaultCamZoom = 0.75;
						curStage = 'dirty-bg';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('trashstageback', 'week1'));
						bg.antialiasing = true;
		...
		if (gameplayArea == "Story" && _variables.cutscene)
		{
			switch (curSong.toLowerCase())
			{
				...
				case 'trashman' | 'rotten' | 'mutant':
					...
					//if the mod ever needs uhh cutscense do this me FlxG.switchState(new VideoState('assets/videos/dono.webm', new Playstate()));
				default:
					dialogueOrCountdown();
			}
		}
	...
	{
		FlxG.sound.play(Paths.sound('poison_hit', 'shared'), _variables.mvolume/100);
//		boyfriend.playAnim("oops", true);
		...
		{
			thething.loadGraphic(Paths.image('poison_image_2', 'shared'));
			thething.animation.add('idle', [0]);
		}
		...
		{
			thething.animation.addByPrefix('idle', 'here', 24, false);
		}
		else if (randomthing == 6)
		{
			thething.animation.addByPrefix('idle', 'sad', 24, false);
		}
		else if (randomthing == 7)
		{
			thething.animation.addByPrefix('idle', 'this', 24, false);
		}
		else if (randomthing == 8)
		{
			thething.animation.addByPrefix('idle', 'is', 24, false);
		}
		else if (randomthing == 9)
		{
			thething.animation.addByPrefix('idle', 'un', 24, false);
		}
