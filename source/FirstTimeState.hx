...
class FirstTimeState extends MusicBeatState
{
	...
	override function create()
	{
		...
		txt = new FlxText(0, 360, FlxG.width,
			"WARNING:\nFNF: VS Trashman Up may potentially trigger seizures for people with photosensitive epilepsy. Viewer discretion is advised.\n\n"
			+ "FNF: VS Trashman is a non-profit modification, aimed for entertainment purposes, and wasn't meant to be an attack on Ninjamuffin99"
