...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		FlxG.save.bind('save', "Funkin VS trashman");
		...
		gfDance = new FlxSprite(FlxG.width * 0.45, FlxG.height * 1.3);
		...
		gradientBar = FlxGradient.createGradientFlxSprite(Math.round(FlxG.width), 512, [0x002cb000, 0x55242424, 0xAAff0000], 1, 90, true);
	...
	override function beatHit()
	{
		...
		{
			case 6:
				createCoolText(['Purble', 'Heighx', 'Frimple Schnips', 'Khrigar', 'Single_ProjectsMusic', 'ThatCoolBaro', 'CanadianGoose', 'CowEnjoyer', 'present']);
			// credTextShit.text += '\npresent...';
	...
	function skipIntro():Void
	{
		if (!skippedIntro)
		{
			...
			//FlxTween.tween(gfDance, {x: 10}, 2.3, {ease: FlxEase.expoInOut, startDelay: 0.8});
			remove(credGroup);
